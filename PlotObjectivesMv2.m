...
% function [hh,idx] = PlotObjectivesM(XX1,OFnames,OFscales,bycolor,bysize,ncolor,nsizes,out_clr,xbrush)
%
...
%   ifig = 3;  
  ...
  switch nargin
    ...
    case 1;
      ...
      [hh,idx] = PlotObjectivesMv2(XX1,OFnames,OFscales,bycolor,bysize,ncolor,nsizes,out_clr,xbrush);
...
%           ifigs = ifigs(1,:); % single plot
          ...
          for isub = 1:nsub;
            ...
            if (isub == nsub);
              ...
              plot(round(xmin(x1),ndecimals),round(xmin(y1),ndecimals),...
                'p','Markersize',12,...
                'MarkerEdgecolor','k',...
                'Markerfacecolor','y');
              hold on;
              ...
              plot(XX1(BTOpos,x1),XX1(BTOpos,y1),...
                'h','Markersize',10,...
                'MarkerEdgecolor','k',...
                'Markerfacecolor','w');
              hold on;
...
%                     'MarkerEdgecolor',[0.2 0.2 0.2]);
            ...
            set(gca,'xtick', round(xmin(x1) + (0.00:0.25:1.00).*(xmax(x1)-xmin(x1)),ndecimals));
            
            set(gca,'XScale',OFscales{x1});
            xlab = xlabel(OFnames{x1});
            ...
            set(gca,'ytick', round(xmin(y1) + (0.00:0.25:1.00).*(xmax(y1)-xmin(y1)),ndecimals));
            set(gca,'YScale',OFscales{y1});
            ylab = ylabel(OFnames{y1});
